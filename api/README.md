...
```toml
[dependencies]
tauri-plugin-android-player = "0.2.3"
```
...
```bash
pnpm add tauri-plugin-android-player-api@0.2.3 -E
# or
npm install tauri-plugin-android-player-api@0.2.3 --save-exact
# or
yarn add tauri-plugin-android-player-api@0.2.3 --exact
```
